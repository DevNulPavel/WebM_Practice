...
void vpx_lpf_horizontal_16_c(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
#define vpx_lpf_horizontal_16 vpx_lpf_horizontal_16_c
    
void vpx_lpf_horizontal_16_dual_c(uint8_t *s, int p, const uint8_t *blimit, const uint8_t *limit, const uint8_t *thresh);
...
uint64_t vpx_sum_squares_2d_i16_c(const int16_t *src, int src_stride, int size);
